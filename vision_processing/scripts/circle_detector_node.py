...
class VisionProcessingNode(Node):
    def __init__(self):
        super().__init__('vision_processing_node2')
        ...
        # Load sounds
        self.countdown_sound = pygame.mixer.Sound("/home/borot/Desktop/Bittle_War/src/vision_processing/Music/3.wav")  # Path to countdown sound file
